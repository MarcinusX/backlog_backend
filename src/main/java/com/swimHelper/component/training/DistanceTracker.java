...
public class DistanceTracker {
    ...
    private Integer countDistanceByDates(User user, LocalDateTime startDate, LocalDateTime endDate) {
    ...
    private Integer countDistanceByTrainingId(User user, Long trainingId) {
    ...
    private Integer countDistanceByUser(User user) {
        List<Training> trainings = trainingRepository.findTrainingsByUser(user.getId());
        return trainings.stream().mapToInt(this::countDistanceForOneTraining).sum();
    }

    private Integer countDistanceForOneTraining(Training training) {
